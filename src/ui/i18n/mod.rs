...
pub enum L10nKey {
    ...
    EditorBinaryFile,
    PanelInfoTitle,
    /// The tab tile's tooltip.
    PanelChangesTitle,
    /// The panel's own header. Separate from the tooltip so the two can differ
    /// in length without one of them reading wrong.
    PanelScmTitle,
    PanelFilesTitle,
    PanelNoSession,
    PanelNoSessionHint,
    ...
    ScmOpenConflict,
    ScmMarkResolved,
    /// Tooltip on the greyed-out buttons of a row whose path is not valid
    /// UTF-8: the control protocol carries argv as strings, so such a path
    /// cannot be handed to git at all. Read-only is the designed fallback.
    ...
    ScmSwitchRepository,
    ScmFilesChanged,
    /// The staged-file count that sits to the left of the Commit button.
    ScmStagedFileCount,
    WindowStop,
    WindowDelete,
    WindowThisWorkspace,
...
mod tests {
    ...
    fn zh_translations_cover_the_initial_keys() {
        for key in [
            ...
            L10nKey::SettingsUpdateVerifying,
            L10nKey::SettingsUpdateCancel,
            L10nKey::SettingsUpdateRetry,
            L10nKey::SettingsUpdateDismiss,
            ...
            L10nKey::SettingsUpdateInstallNow,
            L10nKey::SettingsUpdateDiscard,
            L10nKey::SettingsAutoDownload,
            L10nKey::SettingsAutoDownloadDesc,
            L10nKey::SettingsUpdateChannel,
            ...
            L10nKey::SettingsDaemonStaleRestart,
            L10nKey::UpdateDialogTitle,
            L10nKey::UpdateDialogDetail,
            L10nKey::UpdateDialogDetailWindows,
            L10nKey::UpdateDialogDetailManual,
            L10nKey::UpdateDialogCannotSelfUpdate,
            L10nKey::UpdateDialogLater,
            L10nKey::UpdateDialogNextLaunch,
